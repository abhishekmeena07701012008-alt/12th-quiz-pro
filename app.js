...
// 3. क्विज़ शुरू करना (सुपर-यूनिवर्सल फ़िल्टर लॉजिक जो तीनों फॉर्मेट्स से डेटा निकालेगा)
function startQuiz(subjectKey) {
    ...
    if (typeof quizDataMaster !== 'undefined' && Array.isArray(quizDataMaster)) {
        quizDataMaster.forEach(item => {
            ...
            // विषय का नाम मैच करने के लिए क्लीनिंग
            ...
            if (isSubjectMatch) {
                // फॉर्मेट 3 का चेक: अगर आइटम के अंदर 'questions' नाम का सब-एरे है
                if (item.questions && Array.isArray(item.questions)) {
                    item.questions.forEach(subQ => {
                        filteredQuestions.push({
                            question: subQ.q || subQ.question,
                            options: subQ.options,
                            correct: subQ.correct !== undefined ? subQ.correct : subQ.answer
                        });
                    });
                } 
                // फॉर्मेट 1 और 2 का चेक: अगर आइटम खुद ही एक डायरेक्ट प्रश्न है
                else if (item.options) {
                    // भाषा मैच करना (अगर lang दिया है तो फ़िल्टर करें, 'hi_en' या 'hi-en' को दोनों भाषाओं के लिए वैलिड मानें)
    ...
    // अगर कोई सवाल नहीं मिले तो प्यार से अलर्ट
